      ...
      <ScreenBezel glow="info" className="w-full max-w-md">
        <div className="p-8 pt-10 space-y-6">
          ...
          >
            ...
            >
              {loading ? t('login.processing') : showRegister ? t('login.createAccount') : t('login.accessSystem')}
            </button>
          </form>
          ...
          <div className="border-t border-border-default pt-4 text-center">
            <p className="text-xs uppercase tracking-widest opacity-70 mb-3">
              {showRegister ? t('login.alreadyHaveAccess') : t('login.needCredentials')}
            </p>
            <button
              onClick={() => {
            ...
            >
              {showRegister ? t('login.returnToLogin') : t('login.registerNewAccount')}
            </button>
          </div>
        </div>
      </ScreenBezel>
