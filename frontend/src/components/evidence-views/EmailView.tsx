      ...
      <div className="bg-paper p-5 text-paper-text">
        <div className="mb-3 space-y-1 border-b border-black/15 pb-3 text-sm">
          <div className="flex gap-2">
            <span className="w-16 shrink-0 text-paper-text/60">{t('evidenceView.from')}</span>
            <span>
              {details.fromName} <span className="text-paper-text/60">&lt;{details.from}&gt;</span>
            </span>
          </div>
          <div className="flex gap-2">
            <span className="w-16 shrink-0 text-paper-text/60">{t('evidenceView.to')}</span>
            <span>{details.to}</span>
          </div>
          <div className="flex gap-2">
            <span className="w-16 shrink-0 text-paper-text/60">{t('evidenceView.date')}</span>
            <span>{details.sentAt}</span>
          </div>
          <div className="flex gap-2 font-bold">
            <span className="w-16 shrink-0 font-normal text-paper-text/60">{t('evidenceView.subject')}</span>
        ...
        <a
          ...
          title={t('evidenceView.doNotClick')}
        >
